 # Test file used to test each implemented instruction at the end of Lab3
...
_start:
    ...
    addi x4, x0, 0x1000  # x4 = 0x1000 (Base address for memory tests)
    ...
    # ----------------------
    li x31, 0xDEADBEEF   # Load an arbitrary stop signal value
    sw x31, 0x2FFFC(x0)  # Store value at address 0x2FFFC to signal simulation stop
